...
namespace JsReportVSTools
{
    ...
    /// </summary>
    [Guid(GuidList.guidJsReportVSToolsEditorFactoryString)]
    public sealed class JsRepEditorFactory : IVsEditorFactory, IDisposable
    {
        private JsReportVSToolsPackage editorPackage;
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidJsReportVSToolsEditorFactory;
            pgrfCDW = 0;
            ...
            JsRepEditorPane NewEditor = new JsRepEditorPane(editorPackage);
