...
namespace JsReportVSTools
{
    ...
    //     - An empty jsrep file in the same directory as NewFileItems.vsdir. In
    //       our case we chose Report.jsrep. Note this file name appears in Editor.vsdir
    ...
    //          - "Report" - This is the base file name. New files will initially
    //             be named as Report1.jsrep, Report2.jsrep... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    Report.jsrep|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - Report.jsrep - our empty jsrep file
                                                          ...
                                                          
    {
        ...
        private const string MyExtension = ".jsrep";    

        private class EditorProperties
        {
            private JsRepEditorPane editor;
            public EditorProperties(JsRepEditorPane Editor)
            {
                editor = Editor;
            }
        ...
        #region Fields
        private JsReportVSToolsPackage myPackage;
        ...
        {
            pClassID = GuidList.guidJsReportVSToolsEditorFactory;
