...
namespace Company.VSPackage2
{
    ...
    //     - An empty vspackage2 file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.vspackage2. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.vspackage2, MyExtFile2.vspackage2... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.vspackage2|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.vspackage2 - our empty vspackage2 file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".vspackage2";
        ...
        #region Fields
        private VSPackage2Package myPackage;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVSPackage2CmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVSPackage2CmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidVSPackage2EditorFactory;
            return VSConstants.S_OK;
        }
